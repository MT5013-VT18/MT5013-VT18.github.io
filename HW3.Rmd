...
Data till uppgiften finns på <https://github.com/MT5013-VT18/HW_data> som `StopArea.json`, `Line.json` och `JourneyPattern.json`. Ladda ner dessa och placera i ett uderbibliotek `data` till ditt `Homework`-repo.
